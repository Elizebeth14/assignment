		...
		<label="welcomemsg">WELCOME: </label><label for="name"><?php echo $fname; ?></label>
			<div class="style">	
				<div class="alpha">
					...
					<input name="user" type="hidden" value="<?php echo $fname ?>"/>
					<div class="refresh">
					</div>
					<br/>
					<form name="newMessage" class="newMessage" action="" onSubmit="return false">
                    <input type="hidden" name="user" value="<?php echo $fname ?>"/>
                    <input type="hidden" name="msg_from" id="texta" value="<?php echo $id; ?>">
                    <input type="hidden" name="msg_to" id="recipient"value="<?php echo $msg_to; ?>">
                    <input  type="text" name="recipient" readonly value="Send message to <?php echo $msg_toname ?>"/>
